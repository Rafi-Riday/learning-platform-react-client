...
import Data from '../utilities/blog.json';
import './blog.css';

const Blog = () => {

    const blogContentTemplate = (question, answer) => {
        return <>
    ...
    return (
        <div className='h-full'>
            <Masonry
                ...
                {
                    Data.map((d, ix) => <div className='mb-4 md:mb-5' key={ix}>{blogContentTemplate(d.question, d.answer)}</div>)
                }
            </Masonry>
        </div>
    );
