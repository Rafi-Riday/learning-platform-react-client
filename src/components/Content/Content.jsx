...
const Content = () => {
    ...
    return (
        <>
            <div ref={ref} className={`transition-all duration-500 fixed sm:sticky ${navBarY === 'top-0' ? 'top-16' : '-top-56'} left-0 flex flex-col items-center gap-4 z-10 bg-base-100 pt-4 border-b-4 sm:border-b-0`}>
